...
- 最近更新时间：2026-05-04
- 当前进展：已基于 SwiftPM + SwiftUI 搭建 Sotto Mac App，实现稿件粘贴、确定性切分、手动切分点、聚光流预览、本地最近稿件保存和 AppKit 提词浮窗；已按参考图方向重构为暗色点阵、暖白柔光和全局中文像素字体风格；首页收紧为更合适的竖向舞台比例，编辑页改为横向三栏工作台，正式提词窗口保持横向较大展示。
- 当前阻塞：暂无
